...
public class MainActivity extends AppCompatActivity implements ForecastFragment.Callback, GoogleApiClient.ConnectionCallbacks, GoogleApiClient.OnConnectionFailedListener {
    ...
    private class DataItemGenerator implements Runnable {
        ...
        public DataItemGenerator(int high_temp,int low_temp, int weather_id){
        ...
        @Override
        public void run() {
            PutDataMapRequest putDataMapRequest = PutDataMapRequest.create(UPDATE_TEMP);
            putDataMapRequest.getDataMap().putInt("high_temp", high_temp);
            putDataMapRequest.getDataMap().putInt("low_temp", low_temp);
    ...
    public void generateDataItem(int highTemp, int lowTemp, int weatherId){
        new Thread(new DataItemGenerator(highTemp,lowTemp,weatherId)).start();
    }
